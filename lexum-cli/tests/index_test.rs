...
"#;
    ...
    let result = index::create("http://localhost:9200", "test_index", schema_file.to_str().unwrap()).await;
...
"#;
    ...
    let result = index::create("http://localhost:9200", special_name, schema_file.to_str().unwrap()).await;
